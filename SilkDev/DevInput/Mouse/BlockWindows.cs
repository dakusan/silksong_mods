...
internal class BlockWindows_UniverseLib(string Title, string CanvasRootName, ConfigEntry<bool>? CE, int Priority) : SilkDev.Windows.Window(Title, true, Priority)
{
