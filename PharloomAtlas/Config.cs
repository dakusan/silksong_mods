...
public class Config
{
	...
	internal Config(ConfigFile PConfig)
	{
		...
		Title="Internal";
		UseErrorLog				=Con.Bind(Title, "Write Atlas errors to error file",		true, $"Saves errors generated by the Atlas to {Plugin.PAtlasErrorLogName}", IsAdvanced);
