...
public class Config
{
	...
	internal Config(ConfigFile PConfig)
	{
		...
		Title="Internal";
		UseErrorLog				=Con.Bind(Title, "Write Atlas errors to error file",		true, $"Saves errors generated by the Atlas to {Plugin.CErrorLog.PAtlasErrorLogName}", IsAdvanced);
		UseErrorLogSend			=Con.Bind(Title, "Click here to send Atlas errors to dev",	true, $"Errors generated and saved to {Plugin.CErrorLog.PAtlasErrorLogName} will be sent to the developer", IsAdvanced);
