...
<br>Move with arrow keys or controller stick – full 360° freedom.
<br>Config menu available via **F1**.
<br>User interfaces translated [via LLM] into 20 languages.
<br>💡️ **Important note**: Having the configuration window focused can block keyboard input.
...
1. If you use my other mods — [Plugin Developer Tools](https://www.nexusmods.com/hollowknightsilksong/mods/510) — move them into the same **dakusan** folder.
1. Run the game – done!
